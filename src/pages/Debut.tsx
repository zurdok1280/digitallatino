...
import { digitalLatinoApi, Country, Format, City, Song, DebutSongs } from "@/lib/api";
// Import album covers
  ...
  const fetchSongs = async () => {
    const data = await callApi(async () => {
      ...
      try {
        ...
        console.log('Fetching songs with:', { selectedFormat, selectedCountry, selectedPeriod, selectedCity });
